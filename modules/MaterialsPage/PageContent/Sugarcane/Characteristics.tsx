...
import MicrowaveIcon from "../../../../asset/svgs/icons/Characteristics/MicrowaveIcon";
...
const characteristicsPlaceholder = [
  {
    ...
    desc: "Made from natural sugarcane fiber",
    icon: <SugarcaneIcon {...svgProps} />,
  },
  {
  ...
  {
    title: "Microwave and Water Safe",
    desc: "Can be microwaved and resistant to water and grease",
    icon: <MicrowaveIcon {...svgProps} />,
  },
  {
