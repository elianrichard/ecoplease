    ...
    <div className="flex w-full flex-col gap-10">
      <div className="flex w-full flex-col items-center gap-20 lg:flex-row">
        <div className="relative flex flex-1 justify-end">
          <div className="absolute -bottom-8 right-20 h-72 w-40 bg-darkRed lg:h-96 lg:w-60 xs:h-80 xs:w-52" />
          <div className="z-0 aspect-square h-48 bg-black lg:h-72 xs:h-60 " />
        </div>
      ...
      <div className="flex w-full flex-col-reverse items-center gap-28 md:mt-20 md:flex-row-reverse md:items-start md:gap-10 lg:gap-20">
        <div className="relative flex flex-1 flex-row-reverse md:justify-end">
          <div className="absolute -top-16 left-32 h-60 w-40 bg-darkRed lg:h-80 lg:w-60 xs:h-72 xs:w-52 " />
          <div className="z-0 h-52 w-60 bg-black lg:h-72 lg:w-80 xs:h-64 xs:w-72 " />
        </div>
      ...
      <div className="flex w-full flex-col-reverse items-center gap-10 lg:-mt-20 md:flex-row lg:items-end xl:gap-20">
        <div className="relative flex flex-1 justify-end">
          <div className="absolute -bottom-8 right-10 lg:right-20 h-52 w-72 bg-darkRed lg:h-60 lg:w-80" />
          <div className="z-0 h-72 w-52 bg-black lg:h-80 lg:w-60 " />
        </div>
