...
const Layout = () => {
  return (
    ...
    >
      <EconewsRipped />
      <EconewsRippedFlip />
      <div className="min-h-screen w-full bg-black/30 p-16">
        <div className="mb-16 text-center text-skinCream">
          <p className="before:title-outline-skinCream relative z-0 mb-5 text-5xl font-bold before:absolute before:top-1 before:-z-10 before:translate-x-1 before:content-['ECO_NEWS']">
            ECO NEWS
          </p>
          <p className="text-xl">Your daily dose of eco-fiendly news</p>
        </div>
