    ...
    >
      ...
      <div className="z-10 flex w-full flex-col items-center justify-center gap-10 py-32 lg:w-4/5 lg:flex-row lg:py-0">
        <div className="flex w-full flex-col items-center justify-center lg:items-start">
          ...
          <a
            href="#"
            className="clip-path-triangle relative mb-5 bg-skinCream py-2 px-10 text-2xl font-bold text-darkRed transition-all duration-200 ease-out hover:px-16 lg:bg-ecoRed lg:text-3xl lg:text-skinCream lg:hover:pl-16 lg:hover:text-white"
          >
            OUR CATALOG
          </a>
          <a
